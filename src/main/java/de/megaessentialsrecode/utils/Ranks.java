...
public class Ranks {
    ...
    public static String Ownerprefix = "\uE50F §7| §r";
    public static String Adminprefix = "\uE50A §7| §r";
    public static String Moderatorprefix = "\uE50B §7| §r";
    public static String Builderprefix = "\uE530 §7| §r";
    public static String Supporterprefix = "\uE50C §7| §r";
    ...
    public static String Spielerprefix = "\uE517 §7| §r";
