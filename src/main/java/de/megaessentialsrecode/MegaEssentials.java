...
public final class MegaEssentials extends JavaPlugin{
    ...
    public void onEnable() {
        ...
        createTables();
            ...
            Objects.requireNonNull(getCommand("balance")).setExecutor(new balance(dataBase));
            Objects.requireNonNull(getCommand("money")).setExecutor(new balance(dataBase));
            Objects.requireNonNull(getCommand("bank")).setExecutor(new bank(dataBase));
